<!-- Este tpl contiene el pie de la pagina y el llamado al script de navegacion-->

<footer class="text-center ">
      <p class="" >Created by Group 4 <a href="https://github.com/santiago-a-vidal/GarbageMap">Github/GarbageMap</a>.</p>
    </div>
</footer>
