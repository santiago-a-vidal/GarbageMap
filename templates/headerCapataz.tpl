    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          <li> <a id="mb" href="" >Mapa de la basura<span class="sr-only">(current)</span></a></li>  <!-- Opcion que nos dirige al formulario de denuncia comun-->
          ...
          <form action="" class="navbar-form navbar-left" method="POST" enctype="multipart/form-data" id="loginw" role="logear">
            <div class="form-group">
              ...
              <select class="form-control" id="usuarioMenu">
                ...
                <option value="Capataz" selected="Capataz">Capataz</option>
              </select>
            </div>
            {if isset($key_error)}
